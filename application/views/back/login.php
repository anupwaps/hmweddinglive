		    ...
		    <div class="cls-content-sm panel">
		        <div class="panel-body">
		            <div class="mar-ver pad-btm">
                        ...
                        ?>
                                <img src="<?=base_url()?>uploads/footer_logo/<?=$footer_logo[0]['image']?>" style="width:50% ">
                        <?php
                            }
                            else {
                        ?>
		            ...
		            <form action="<?=base_url()?>admin/check_login" method="POST">
		                <div class="form-group">
		                    <input type="text" class="form-control" name="email" placeholder="Username" autofocus required>
		                </div>
		                <div class="form-group">
