...
<form class="form-horizontal" id="general_settings_form" method="POST" action="<?=base_url()?>admin/general_settings/update_general_settings">
	...
	<div class="form-group">
		<label class="col-sm-3 control-label" for="working_day"><b><?php echo translate('working_day')?></b></label>
		<div class="col-sm-8">
			<input type="text" class="form-control" name="working_day" value="<?=$this->Crud_model->get_type_name_by_id('general_settings', '87', 'value')?>" placeholder="Working day">
		</div>
	</div>
	<div class="form-group">
		<label class="col-sm-3 control-label" for="working_hours"><b><?php echo translate('working_hours')?></b></label>
		<div class="col-sm-8">
			<input type="text" class="form-control" name="working_hours" value="<?=$this->Crud_model->get_type_name_by_id('general_settings', '88', 'value')?>" placeholder="Working hours">
		</div>
	</div>
	<div class="form-group">
		<label class="col-sm-3 control-label" for="app_store_apple"><b><?php echo translate('app_store_apple')?></b></label>
		<div class="col-sm-8">
			<input type="text" class="form-control" name="app_store_apple" value="<?=$this->Crud_model->get_type_name_by_id('general_settings', '89', 'value')?>" placeholder="Apple play store link">
		</div>
	</div>
	<div class="form-group">
		<label class="col-sm-3 control-label" for="play_store_google"><b><?php echo translate('play_store_google')?></b></label>
		<div class="col-sm-8">
			<input type="text" class="form-control" name="play_store_google" value="<?=$this->Crud_model->get_type_name_by_id('general_settings', '90', 'value')?>" placeholder="Google play store link">
		</div>
	</div>
	<div class="form-group">
		<label class="col-sm-3 control-label" for="slider_heading"><b><?php echo translate('slider_heading')?></b></label>
		<div class="col-sm-8">
			<input type="text" class="form-control" name="slider_heading" value="<?=$this->Crud_model->get_type_name_by_id('general_settings', '91', 'value')?>" placeholder="Slider Heading Text">
		</div>
	</div>
	<div class="form-group">
	...
	<div class="form-group">
		<label class="col-sm-3 control-label" for="language"><b><?php echo translate('language')?></b></label>
        <div class="col-sm-6">
    ...
    <div class="form-group">
    	<label class="col-sm-3 control-label" for="member_approval_by_admin"><b><?php echo translate('member_approval_by_admin')?></b></label>
        <div class="col-sm-6">
