                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group has-feedback">
                            ...
                            <input type="number" class="form-control form-control-sm" name="aged_from" id="aged_from" value="" min="18" max="54">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group has-feedback">
                            ...
                            <input type="number" class="form-control form-control-sm" name="aged_to" id="aged_to" value="" min="18" max="54">
                        </div>
                        <div class="help-block with-errors">
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group has-feedback">
                            ...
                            <input type="text" class="form-control form-control-sm height_mask" name="min_height" id=""  min="4.0" max="7.0">
                            <div class="help-block with-errors">
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="form-group has-feedback">
                            ...
                            <input type="text" class="form-control form-control-sm height_mask" name="max_height" id="" min="4.0" max="7.0">
                        </div>
                        <div class="help-block with-errors">
                        </div>
                    </div>
