<div class="main page-bg">
        <div class="about-heading" style="padding: 80px 240px; height:auto;">
...
<script>
    ...
    function filter_members(page, type){
        if (type == 'search')
        {
            var url = '<?php echo base_url(); ?>home/ajax_member_list2/'+page+'/'+type;
        }
        else {
            var member_type = "";
            if ($("#member_type").val() != "") {
            ...
            var url = '<?php echo base_url(); ?>home/ajax_member_list2/'+page+'/'+member_type;
        }
