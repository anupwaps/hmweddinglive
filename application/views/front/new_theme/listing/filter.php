    ...
    <div class="sidebar">
        <div class="">
            <div class="card">
                ...
                <div class="card-body">
                    <form class="form-default" id="filter_form" data-toggle="validator" role="form" action="<?=base_url()?>home/listing2/searching" method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12">
                                ...
                                <div class="form-group has-feedback">
                                    ...
                                    <?= $this->Crud_model->select_html('country', 'country', 'name', 'edit', 'form-control form-control-sm selectpicker s_country', $country , '', '', ''); ?>
                                    <div class="help-block with-errors">
                                    </div>
                                </div>
                                <div class="form-group has-feedback">
                        ...
                        <button type="submit" class="btn btn-block btn-base-1 mt-2 z-depth-2-bottom"><?php echo translate('search')?></button>
                    </form>
                </div>
            </div>
        </div>
