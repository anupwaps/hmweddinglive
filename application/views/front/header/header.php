					...
					<div id="myHeader">
						...
						<nav class="navbar navbar-expand-lg navbar-light bg-default navbar--link-arrow navbar--uppercase">
						    <div class="container navbar-container">
						        <!-- Brand/Logo -->
						        <a class="navbar-brand" href="<?=base_url()?>home/" style="width: 50%;">
						        	<?php
	                                    ...
	                                    ?>
	                                        <img src="<?=base_url()?>uploads/header_logo/<?=$header_logo[0]['image']?>" class="img-responsive" height="100%" style="width: 20%;">
	                                    <?php
	                                    }
	                                    else {
	                                    ?>
						        ...
						        <div class="collapse navbar-collapse align-items-center justify-content-end" id="navbar_main">
						            ...
						            <ul class="navbar-nav" data-hover="dropdown">
						                ...
						                <li class="custom-nav">
						                <a class="nav-link <?php if($page == 'contact_us'){?>nav_active<?php }?>" href="<?=base_url()?>home/about_us" aria-haspopup="true" aria-expanded="false">
						                <?php echo translate('about_us')?></a>
						                </li>
						            </ul>
						        </div>
						    </div>
