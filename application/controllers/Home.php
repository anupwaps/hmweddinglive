...
class Home extends CI_Controller {
    ...
    function top_bar_right2() {
        recache();
        $this->load->view('front/new_theme/top/log_stat.php');
    }
    function side_top_bar() {
        recache();
        $this->load->view('front/new_theme/top/log_stat2.php');
    }
    ...
    function listing($para1="",$para2="")
    {
        ...
        elseif ($para1=="search_by_country" && $para2) {
            // var_dump($para2);
            $page_data['title'] = "Listing Page || ".$this->system_title;
            $page_data['top'] = "listing.php";
            $page_data['page'] = "listing";
    ...
    function add_interest($member_id)
    {
        ...
        if ($express_interest > 0) {
            ...
            $this->Email_model->express_interest_email($member);
                    ...
                    if ($safe == 'yes') {
                        ...
                        if ($this->Crud_model->get_settings_value('third_party_settings', 'captcha_status', 'value') == 'ok') {
                            ...
                            if ($response['success']) {
                                ...
                                $member_profile_id = 'HM_'.strtoupper(substr(hash('sha512', rand()), 0, 8)).$insert_id;
